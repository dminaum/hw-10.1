...
def sort_dataframes_by_desc(transactions: List[Dict], match: str) -> List[Dict]:
    """Принимает список словарей с данными о банковских операциях и строку поиска. Возвращает список словарей, у которых в описании есть данная строка."""
    result_list = []
...
class TestSortDataframesByDesc(unittest.TestCase):
    ...
    def test_sort_dataframes_by_desc_found(self):
    ...
    def test_sort_dataframes_by_desc_not_found(self):
    ...
    def test_sort_dataframes_by_desc_case_insensitive(self):
